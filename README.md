...
- Full v1.0 community bridge paper source
- Printable family handout source
...
The generated DOCX/PDF release files are available from the local release packet. Because this connector can commit UTF-8 text files but not binary DOCX/PDF files, upload the generated documents manually into `docs/downloads/` or attach them to a GitHub Release.
...
Creative Commons Attribution 4.0 International (**CC BY 4.0**) is recommended if you want people to share and adapt this resource with attribution.

## Core boundary

> AI can help, but it does not rule.
